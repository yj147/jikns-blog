...
const data = JSON.parse(
  fs.readFileSync("perf-results/phase2-critical-css_run3_20251112.json", "utf8")
)
...
console.log(
  `- Total Byte Weight: ${Math.round(data.audits["total-byte-weight"].numericValue / 1024)}KB`
)
